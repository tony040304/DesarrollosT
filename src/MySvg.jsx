...
const MySvg = ({ color = 'text-neonblue', onClick }) => {
    return (
        <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 500.000000 500.000000" className={`${color} w-28 fixed bottom-10 cursor-pointer -right-8 transition duration-300 ease-in-out z-49`} preserveAspectRatio="xMidYMid meet">
