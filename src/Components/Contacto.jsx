...
const Contacto = () => {
    ...
    return (
        <div className='w-full h-screen flex bg-white bg-center text-white flex-col items-center'>
            ...
            <div className='w-5/6 lg:w-1/2 flex items-center justify-center bg-neonblue mt-10 p-5 rounded-lg'>
                <ContactForm />
            </div>
                ...
                <div className='flex flex-col justify-between w-full pt-4'>
                    <div className='flex flex-col justify-center items-center mb-10'>
                        ...
                        <div className='flex flex-row justify-between gap-8'>
                            ...
                            <button
                                onClick={() => GoWhats()}
                                className="bg-gradient-to-tr from-lime-400 to-lime-300 shadow-lg shadow-lime-900/50 p-1.5 rounded-md font-bold xl:w-fit xl:text-xl transition delay-100 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 cursor-pointer"
                            >
                                WhatsApp
                            </button>
                        </div>
