...
const PresentationComponents = ({ title, paragraph, extra, info, where }) => {
  ...
  return (
    <>
      <div onClick={() => { nav(`/${where}`); }} className="cursor-pointer rounded-2xl flex flex-row items-center justify-center max-h-60 mb-12 md:w-6/7 lg:w-200 xl:w-2/3 2xl:w-1/2 border-l-2 border-l-neon border border-neonblue/20 bg-white shadow-[inset_0_0_30px_rgba(59,130,246,0.3)] backdrop-blur-2xl transition-all duration-300 hover:scale-105 hover:shadow-[inset_0_0_30px_rgba(59,130,246,0.5)]">
        <div className='flex flex-col items-center justify-center border-r-2 h-full border-neonblue pl-0 p-2 min-w-1/3 lg:min-w-1/4'>
          <h1 className='text-neon text-center font-bold text-md text-wrap 2xl:text-lg text-shadow-2xs text-shadow-black/50 p-2'>{title}</h1>
        </div>
